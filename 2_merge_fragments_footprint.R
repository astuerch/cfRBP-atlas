...
# Load the data
#input_file <- "/Users/alessandra/polybox/sequencing/RNA-seq_analysis/IGV_CLIP_analysis/SSB/02.CM_differential_peaks_protected/SSB_CM_protected_peaks.bed"  # Replace with your actual file path
...
#output_file <- "/Users/alessandra/polybox/sequencing/RNA-seq_analysis/IGV_CLIP_analysis/SSB/02.CM_differential_peaks_protected/SSB_CM_protected_peaks_merged.bed"  # Specify your desired output file path
