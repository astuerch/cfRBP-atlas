...
colData_cell <- subset(colData_batch, genotype %in% c('WT', 'AGO1234') & origin == 'Cell')
colData_cm <- subset(colData_batch, genotype %in% c('WT', 'AGO1234') & origin == 'CM')
...
#results
res_cell <- results(ddsr_cell1, contrast=c("genotype", "AGO1234", "WT"))
res_cm <- results(ddsr_cm1, contrast=c("genotype", "AGO1234", "WT"))
...
write.table(final_counts_cell, "/Users/alessandra/polybox/Shared/cfRBP_atlas_paper/data/from_fig3/deseq_KO_results/diff_Cell_AGO1234_norm_counts_filtered.txt", quote = F, row.names = F, sep = "\t")
write.table(final_counts_cm, "/Users/alessandra/polybox/Shared/cfRBP_atlas_paper/data/from_fig3/deseq_KO_results/diff_CM_AGO1234_norm_counts_filtered.txt", quote = F, row.names = F, sep = "\t")
...
venn.diagram(list(pass_thresholds_cell, pass_thresholds_cm),
             ...
             filename = '~/polybox/sequencing/RNA-seq_analysis/deseq2_analysis/final_batch/smallRNA/RBP_KO_batch/venn_diagram_DEGs/venn_diagramm_AGO1234.png',
             main = "AGO1234 KO",
             main.cex = 5,
             main.fontface = "bold",
             output=TRUE,
...
venn.diagram(list(up_thresholds_cell, up_thresholds_cm),
             ...
             filename = '~/polybox/sequencing/RNA-seq_analysis/deseq2_analysis/final_batch/smallRNA/RBP_KO_batch/venn_diagram_DEGs/venn_diagramm_AGO1234_upregulated.png',
             main = "AGO1234 KO upregulated genes",
             main.cex = 5,
             main.fontface = "bold",
             output=TRUE,
             imagetype="png" ,
...
venn.diagram(list(down_thresholds_cell, down_thresholds_cm),
             ...
             filename = '~/polybox/sequencing/RNA-seq_analysis/deseq2_analysis/final_batch/smallRNA/RBP_KO_batch/venn_diagram_DEGs/venn_diagramm_AGO1234_downregulated.png',
             main = "AGO1234 KO downregulated genes",
             main.cex = 5,
             main.fontface = "bold",
             output=TRUE,
             imagetype="png" ,
