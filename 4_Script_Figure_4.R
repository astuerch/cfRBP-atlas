...
colData_cell <- subset(colData_batch, genotype %in% c('WT', 'DICER') & origin == 'Cell')
colData_cm <- subset(colData_batch, genotype %in% c('WT', 'DICER') & origin == 'CM')
...
#results
res_cell <- results(ddsr_cell, contrast=c("genotype", "DICER", "WT"))
res_cm <- results(ddsr_cm, contrast=c("genotype", "DICER", "WT"))
...
DICER_cell <- table_cell[,c(1,3,6,7)]
colnames(DICER_cell)[2] <- "DICER_log2FoldChange"

DICER_cm <- table_cm[,c(1,3,6,7)]
colnames(DICER_cm)[2] <- "DICER_log2FoldChange"

#join all the statistical data to define dependencies
df_list_cell <- list(DICER_cell, DGCR8_cell, XPO5_cell, DICER_cell, TRBP_cell, PACT_cell, PACT.TRBP_cell, DICER_cell, AGO1_cell,AGO2_cell,AGO3_cell,AGO12_cell,AGO23_cell,AGO123_cell,AGO1234_cell)
...
df_list_cm <- list(DICER_cm, DGCR8_cm, XPO5_cm, DICER_cm, TRBP_cm, PACT_cm, PACT.TRBP_cm, DICER_cm, AGO1_cm,AGO2_cm,AGO3_cm,AGO12_cm,AGO23_cm,AGO123_cm,AGO1234_cm)
