...
# to run in R
data <- read.table("/Users/alessandra/polybox/sequencing/RNA-seq_analysis/RBP_IP_analysis/3-RBP_IP/read_length_fragmentomics/read_length_TDP43_b.txt", quote="\"", comment.char="")

data2 <- read.table("/Users/alessandra/polybox/sequencing/RNA-seq_analysis/RBP_IP_analysis/3-RBP_IP/read_length_fragmentomics/read_length_TDP43_eCLIP.txt", quote="\"", comment.char="")

data$sample <- "TDP43_IP"
data2$sample <- "TDP43_eCLIP"
...
final$V1[final$sample == "TDP43_eCLIP"] <- (final$V1[final$sample == "TDP43_eCLIP"]/sum(final$V1[final$sample == "TDP43_eCLIP"]))  *1000000
...
awk '($3 - $2) > 20' filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a.bed > ./read_length_fragmentomics/filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_above20nt.bed
awk '($3 - $2) <= 20' filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a.bed > ./read_length_fragmentomics/filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_below20nt.bed

awk '($3 - $2) > 20' filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a.bed > ./read_length_fragmentomics/filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_above20nt.bed
awk '($3 - $2) <= 20' filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a.bed > ./read_length_fragmentomics/filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_below20nt.bed
...
#motif enrichment
seq2profile.pl GAATGD 0 TDP43 > TDP43.motif
seq2profile.pl AMAHWCA 0 IGF2BP3 > IGF2BP3.motif
seq2profile.pl VMAHWCA 0 IGF2BP3 > IGF2BP3_.motif

#RNAcompete: 359_12507992, RNCMPT00033: VMAHWCA, RNCMPT00172: AMAHWCA (IGF2BP3)
#other: CAUU
#RNAcompete: RNCMPT00076: GAAUGD, (TDP43)
cd ./read_length_fragmentomics/

findMotifsGenome.pl filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_above20nt.bed hg38 outputDir_IGF2BP3_above20nt/ \
  -size given -p 4 -rna  \
  -bg WT_CM_input_smRNA_merged_sorted_MASTER_a_above20nt.bed  #-find IGF2BP3.motif -keepOverlappingBg

findMotifsGenome.pl filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_above20nt.bed hg38 outputDir_TDP43_above20nt/ \
  -size given -p 4 -rna  \
  -bg WT_CM_input_smRNA_merged_sorted_MASTER_a_above20nt.bed  #-find IGF2BP3.motif -keepOverlappingBg

findMotifsGenome.pl filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_below20nt.bed hg38 outputDir_IGF2BP3_below20nt/ \
  -size given -p 4 -rna  \
  -bg WT_CM_input_smRNA_merged_sorted_MASTER_a_below20nt.bed  #-find IGF2BP3.motif -keepOverlappingBg

findMotifsGenome.pl filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_below20nt.bed hg38 outputDir_TDP43_below20nt/ \
  -size given -p 4 -rna  \
  -bg WT_CM_input_smRNA_merged_sorted_MASTER_a_below20nt.bed  #-find IGF2BP3.motif -keepOverlappingBg
...
bedtools intersect -v -s -a filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_merged.bed -b filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_merged.bed | wc -l #unique_to_A.bed 7318
bedtools intersect -v -s -a filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_merged.bed -b filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_merged.bed | wc -l #unique_to_B.bed 2169
bedtools intersect -u -s -a filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_merged.bed -b filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_merged.bed | wc -l #intersection 1070



######## Figure S6H: GO analysis of bound fragments
##GO analysis in R
awk '{print $8}' /Users/alessandra/polybox/sequencing/RNA-seq_analysis/RBP_IP_analysis/3-RBP_IP/filtered_IGF2BP3_IP_CM_smRNA_merged_sorted_MASTER_a_merged_annotation.txt | uniq > IGF2BP3_IP_MASTER_genes.txt

awk '{print $8}' /Users/alessandra/polybox/sequencing/RNA-seq_analysis/RBP_IP_analysis/3-RBP_IP/filtered_TDP43_IP_CM_smRNA_merged_sorted_MASTER_a_merged_annotation.txt | uniq > TDP43_IP_MASTER_genes.txt
...
IGF2BP3_IP_genes <- read.table("~/polybox/sequencing/RNA-seq_analysis/RBP_IP_analysis/3-RBP_IP/IGF2BP3_IP_MASTER_genes.txt", quote="\"", comment.char="")
TDP43_IP_genes <- read.table("~/polybox/sequencing/RNA-seq_analysis/RBP_IP_analysis/3-RBP_IP/TDP43_IP_MASTER_genes.txt", quote="\"", comment.char="")

# Example: convert gene symbols to ENTREZ IDs
gene_ids_IGF2BP3 <- bitr(IGF2BP3_IP_genes$V1, fromType="SYMBOL", toType="ENTREZID", OrgDb="org.Hs.eg.db")
gene_ids_TDP43 <- bitr(TDP43_IP_genes$V1, fromType="SYMBOL", toType="ENTREZID", OrgDb="org.Hs.eg.db")

# Example data
protein1_results <- as.data.frame(enrichGO(gene = gene_ids_IGF2BP3$ENTREZID, OrgDb = org.Hs.eg.db, ont = "BP", pAdjustMethod = "BH",
                             pvalueCutoff = 0.05,
                             readable = TRUE))
protein2_results <- as.data.frame(enrichGO(gene = gene_ids_TDP43$ENTREZID, OrgDb = org.Hs.eg.db, ont = "BP", pAdjustMethod = "BH",
                             pvalueCutoff = 0.05,
                             readable = TRUE))

# Combine data and add protein labels
protein1_results$Protein <- "IGF2BP3"
protein2_results$Protein <- "TDP43"
...
ggplot(top_n_per_type, aes(x = reorder(Description, -p.adjust), y = -log10(p.adjust), fill = Protein, size = Count)) +
  ...
  scale_fill_manual(values = c("IGF2BP3" = "darkblue", "TDP43" = "cyan4")) +
